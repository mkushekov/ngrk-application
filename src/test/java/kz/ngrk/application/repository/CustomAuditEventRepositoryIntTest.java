package kz.ngrk.application.repository;

import kz.ngrk.application.NgrkApplicationApp;
import kz.ngrk.application.config.Constants;
import kz.ngrk.application.config.audit.AuditEventConverter;
import kz.ngrk.application.domain.PersistentAuditEvent;
...
import static kz.ngrk.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
